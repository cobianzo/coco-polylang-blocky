...
class Admin_Enqueue {
	...
	public static function enqueue_scripts_for_editor_block(): void {
		 ...
		 */
		$asset_file = file_exists( plugin_dir_path( __DIR__ ) . 'build/index.asset.php' )
			? include plugin_dir_path( __DIR__ ) . 'build/index.asset.php'
			: ['dependencies' => ['wp-blocks', 'wp-element', 'wp-editor'], 'version' => time()];

		$script_handle = 'coco-polylang-blocky';
